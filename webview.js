...
let feedScripts = {
	...
	/**
	 * Fixes devRant app links to open externally
	 *
	 * @since       1.3.0
	 */
...
let aboutScripts = {
	...
	renderDialog : function(list) {
		...
		let aboutInfoVersion = '<div class="franz-about-version"><span>Version ' + currentVer + '</span><a href="https://github.com/Section214/franz-devrant/blob/' + currentVer + '/CHANGELOG.md" target="_blank">What\'s New</a></div>';
		let aboutInfoUpdate = '<div class="franz-about-update">' + preUpdate + '</div>';
		let aboutInfoWrapperAfter = '</div><div class="clearfix"></div>';
		
		// Details box
		let aboutDetailsBox = '<div class="franz-about-details"><p>The devRant integration for Franz is designed by <a href="https://section214.com" target="_blank">Section214</a> and is released under the MIT license.</p><p>Questions? Comments? <a href="https://github.com/Section214/franz-devrant/issues" target="_blank">Let us know</a>!</p><p>Want to help? <a href="https://section214.com/donate/" target="_blank">Make a donation</a> or <a href="https://github.com/Section214/franz-devrant/issues" target="_blank">get involved</a>!</p></div>';
		...
		$(list).after(aboutWrapperBefore + aboutIconBox + aboutInfoWrapperBefore + aboutInfoTitle + aboutInfoVersion + aboutInfoUpdate + aboutInfoWrapperAfter + aboutDetailsBox + aboutFooterBox + aboutWrapperAfter);
	},
	/**
...
function updateDisplay(latestVer) {
	if(latestVer === 'error') {
		...
		$('.franz-about-update').html('<a href="https://github.com/Section214/franz-devrant/releases/latest" target="_blank">Version ' + latestVer + ' is available!</a>');
...
module.exports = (Franz, options) => {
	...
	//let updateStatus = readCookie('dr_franz_update');
