...
let aboutScripts = {
	...
	renderDialog : function(list) {
		...
		let aboutInfoVersion = '<div class="franz-about-version"><span>Version ' + currentVer + '</span><a href="https://github.com/extendfranz/devrant/blob/' + currentVer + '/CHANGELOG.md" target="_blank">What\'s New</a></div>';
