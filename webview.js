...
let aboutScripts = {
	...
	renderDialog : function() {
		...
		let aboutInfoVersion = '<div class="franz-about-version"><span>Version ' + ver + '</span><a href="https://github.com/Section214/franz-devrant/blob/' + ver + '/CHANGELOG.md" target="_blank">What\'s New</a></div>';
...
function updateCheck() {
	$.get('https://raw.githubusercontent.com/Section214/franz-devrant/master/package.json', function(data) {
		...
		if (ver < packagedata.version) {
			...
			$('.franz-about-update').html('<a href="https://github.com/Section214/franz-devrant/releases/latest" target="_blank">Version ' + packagedata.version + ' is available!</a>');
		} else {
