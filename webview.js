...
let aboutScripts = {
	...
	renderDialog : function() {
		...
		$('.rantlist').after(aboutWrapperBefore + aboutIconBox + aboutInfoWrapperBefore + aboutInfoTitle + aboutInfoVersion + aboutInfoUpdate + aboutInfoWrapperAfter + aboutDetailsBox + aboutFooterBox + aboutWrapperAfter);
	},
	/**
